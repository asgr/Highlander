...
**40-100 parameters:** fitting will be getting very hard, especially if likelihoods are not auto-differentialable (if they are, then probably you should be using **Stan** or similar at this point). The best approach will take some user experimentation, but CHARM is often not a bad starting point.
