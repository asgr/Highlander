...
Use `keep_all = TRUE` to retain the full output of every parallel chain. This is useful when you want to compare posterior distributions across chains, or diagnose convergence problems:

```{r eval=FALSE}
# Run 4 chains in parallel, keeping all outputs.
High_out_mc_all = Highlander(badpar, ProSpectSEDlike, Data=Data,
  lower=Data$intervals$lo, upper=Data$intervals$hi, Niters=c(200,200),
  cores=4L, keep_all=TRUE)
