...
# Note for Lowlander the only output from out likelihood function has to be LL of ChiSq:
intervals = Lowlander(lower, upper, Data=Data, likefunc=ProSpectSEDlike, ncores=4)
...
High_out = Highlander(badpar, ProSpectSEDlike, Data=Data, lower=lower, upper=upper,
                      Niters=c(200,200))
```
...
High_out_mc = Highlander(badpar, ProSpectSEDlike, Data=Data,
  lower=lower, upper=upper, Niters=c(200,200), cores=4L)
...
High_out_mc_all = Highlander(badpar, ProSpectSEDlike, Data=Data,
  lower=lower, upper=upper, Niters=c(200,200), cores=4L, keepall=TRUE)
